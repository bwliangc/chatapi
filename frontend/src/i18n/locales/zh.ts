export default {
  ...
  leaderboard: {
    title: '排行榜',
    description: '按消费金额排名的实时榜单。冲到前列有机会瓜分每日奖池。',
    tabToday: '今日实时',
    tabYesterday: '昨日结算',
    poolAmount: '预计奖池',
    totalSpend: '总消费',
  ...
  onlinePlayground: {
    title: '在线测试',
    description: '选择你的密钥和模型，直接在浏览器里聊天，支持图片上传。聊天记录不做存储，数据仅用于透传上游。',
    selectKey: '选择密钥',
    noActiveKey: '无可用密钥',
    createKeyHint: '你还没有可用的密钥，请先在「密钥」页面创建一个。',
    selectModel: '选择模型',
    loadingModels: '加载中…',
    modelPlaceholder: '输入或选择模型',
    refreshModels: '刷新模型列表',
    modelsCount: '已自动获取 {count} 个模型',
    modelsManualHint: '未能自动获取模型列表，可手动输入模型名',
    emptyState: '选择密钥和模型后，在下方输入消息开始聊天',
    attachImage: '添加图片',
    ...
    clear: '清空对话',
    fileTooLarge: '文件 {name} 过大（上限 {limit}）',
    streamError: '出错',
  ...
  admin: {
    ...
    costCalculator: {
      title: '成本计算',
      description: '从会计角度查看平台余额、用户扣费、上游成本、固定订阅成本与利润',
      statementTitle: '经营成本报表',
      statementDescription: '按所选时间范围汇总真实用量流水，并结合成本计算设置估算上游成本、固定订阅成本与利润。',
      settings: '设置',
      settingsTitle: '成本计算设置',
      userBilling: '用户扣费收入',
      userBillingHint: '平台余额按充值价格加权单价估算；无充值价格时回退 {rate}',
      upstreamCost: '上游调用成本',
      upstreamCostHint: '按上游账号综合按量成本倍率汇总，未单独配置账号使用默认 {rate}',
      usageGrossProfit: '用量毛利',
      netAfterFixedCost: '扣固定成本后利润',
      netAfterFixedCostHint: '固定成本 {fixed}，排行榜奖励 {rewards}',
      margin: '毛利率',
      fixedCost: '固定成本',
      userBalanceLiability: '平台余额负债',
      userBalanceLiabilityHint: '全量普通用户正余额 {count} 人；估算人民币负债 {estimated}，来源：{source}',
      balanceRechargeRevenue: '余额充值入账',
      balanceRechargeRevenueHint: '按面额价格表匹配 {matched}，未匹配 {unmatched}，共 {count} 条',
      redeemRechargeRevenue: 'CDK 兑换充值',
      redeemRechargeRevenueHint: '已使用余额兑换码 {count} 条',
      adminBalanceAdjustment: '管理员充值入账',
      adminBalanceAdjustmentHint: '共 {count} 条，平台余额加 {added}，扣 {deducted}',
      leaderboardRewardCost: '排行榜奖励发放',
      leaderboardRewardCostHint: '共 {count} 条，发放平台余额 {amount}',
      unmatchedRechargeAmount: '未匹配充值面额',
      unmatchedRechargeAmountHint: '有 {count} 条充值没有匹配面额价格，请在设置中补充',
      accountConfiguredCost: '账号月固定成本',
      accountConfiguredCostHint: '已配置 {count} 个账号',
      accountCostTitle: '账号成本与固定订阅',
      accountCostDescription: '固定成本和综合按量成本倍率来自成本计算设置，不读取账号 extra 字段。',
      proratedDays: '当前区间折算 {days} 天',
      account: '账号',
      platform: '平台',
      usageCost: '窗口成本',
      ...
      quotaRemaining: '剩余额度',
      noAccounts: '暂无已配置账号成本',
      noAccountCosts: '尚未添加账号固定成本',
      unconfigured: '未配置',
      accountingNotesTitle: '口径说明',
      revenueFormula: '收入',
      revenueFormulaValue: '用户扣费优先按充值面额价格表/历史匹配充值得到的加权实际单价估算；余额充值收入按面额价格表匹配实际人民币收款，来自 CDK 兑换和管理员余额充值，管理员用户已排除。',
      costFormula: '上游成本',
      ...
      balanceLiabilitySourcePackage: '当前充值价格表加权',
      balanceLiabilitySourceUnavailable: '未配置价格，仅显示余额',
      groupProfitTitle: '分组利润',
      modelProfitTitle: '模型利润',
      group: '分组',
      income: '收入',
      cost: '成本',
      profit: '利润',
      balanceLiabilityTitle: '余额负债明细',
      balanceLiabilityDescription: '按余额最高的用户排序，用于观察平台待履约金额。',
      pageLoadedRows: '已加载 {count} / {total}',
      user: '用户',
      subscriptions: '订阅数',
      balanceExchangeRate: '人民币兑美元汇率',
      balanceExchangeRateHint: '填写多少人民币可以兑换 1 美元。例如 6.8 元 = 1 USD，则填 6.8。',
      balanceExchangeRateInvalid: '人民币兑美元汇率必须大于 0',
      upstreamCostRate: '默认综合按量成本倍率',
      upstreamCostRateHint: '直接填写人民币/USD 的综合倍率。例如 6.8 汇率且上游 8 折成本，填 6.8 × 0.8 = 5.44。',
      upstreamCostRateInvalid: '默认综合按量成本倍率不能小于 0',
      rechargePackageSettings: '充值面额价格表',
      rechargePackageSettingsHint: '填写平台余额面额对应的实际人民币收款。例如 100 平台余额收 15 元、1000 平台余额收 135 元。',
      addRechargePackage: '添加面额',
      rechargeBalanceAmount: '平台余额面额',
      rechargeActualAmount: '实际收款（人民币）',
      noRechargePackages: '尚未添加充值面额价格',
      rechargePackageBalanceInvalid: '充值面额必须大于 0',
      rechargePackageActualInvalid: '实际收款不能小于 0',
      rechargePackageDuplicate: '充值面额不能重复',
      addAccountCost: '添加账号成本',
      selectAccount: '选择账号',
      settingsSaved: '成本计算设置已保存',
    ...
    groups: {
      ...
      form: {
        ...
        rateMultiplierHint: '1.0 = 标准费率，0.5 = 半价，2.0 = 双倍，0 = 不计费',
        rpmLimit: '每分钟请求数 (RPM)',
        rpmLimitPlaceholder: '0 表示不限制',
    ...
    channelMonitor: {
      ...
      form: {
        ...
        activeWindow: '检测时间段',
        activeWindowHint: '关闭时全天 7×24 检测；开启后仅在所选星期与时段内检测（按服务器本地时区）',
        activeWindowStart: '开始时间',
        activeWindowEnd: '结束时间',
        activeWindowTimeHint: '开始等于结束表示当天全天；开始晚于结束表示跨午夜（如 22:00–06:00）',
        activeWindowWeekdays: '生效星期',
        activeWindowWeekdaysHint: '不选表示每天',
        activeWindowWeekdaysWorkday: '仅工作日',
        activeWindowWeekdaysEveryday: '每天',
        weekday0: '日',
        weekday1: '一',
        weekday2: '二',
        weekday3: '三',
    ...
    settings: {
      ...
      features: {
        ...
        onlinePlayground: {
          title: '在线测试',
          description: '允许已登录用户在浏览器内用自己的密钥选模型聊天（支持图片）。默认关闭。',
          enabled: '启用在线测试',
        ...
        leaderboardReward: {
          title: '排行榜激励',
          description: '每天自动取昨日全站总消费的一定比例作为奖池，按昨日消费排行榜发放余额奖励给前 N 名用户。默认关闭。',
          enabled: '启用排行榜激励',
          enabledHint: '关闭后后台不再发放每日奖励，已发放记录保留。',
          poolRate: '奖池比例',
          poolRateHint: '奖池 = 昨日全站总消费（实际扣费）× 该比例（0-100%，例如填 10 表示取 10%）。',
          topN: '奖励名额（前 N 名）',
          topNHint: '按昨日消费从高到低取前 N 名发放；仅纳入昨日有消费的用户。0 表示不发放。',
          mode: '分配方式',
          modeHint: '决定奖池如何在前 N 名之间分配。',
          modeAverage: '平均分配',
          modeWeighted: '自定义权重',
          weights: '名次权重',
          ...
          minSpend: '参与门槛（最低消费 $）',
          minSpendHint: '个人当日消费达到该金额（美元）才有资格进入中奖区（前 N 名）；0 = 无门槛。奖池仍按全站总消费计算，门槛只决定谁能获奖。',
          rankingVisible: '对用户展示排行榜',
          rankingVisibleHint: '开启后，用户侧边栏出现「排行榜」入口，可查看脱敏后的消费榜与自己的名次。与是否发放奖励相互独立。默认关闭。',
          excludedEmails: '排除名单（邮箱）',
          excludedEmailsHint: '名单内用户不上榜、不参与发奖，且其消耗不计入奖池总额。用逗号、分号或换行分隔多个邮箱。常用于排除管理员/测试/运营账号。留空表示不排除任何人。',
        },
        affiliate: {
          title: '邀请返利',
