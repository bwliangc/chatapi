export default {
  ...
  admin: {
    ...
    costCalculator: {
      ...
      userBilling: '用户扣费收入',
      userBillingHint: '平台 USD 余额按 {rate} 折算为人民币',
      upstreamCost: '上游调用成本',
      ...
      userBalanceLiabilityHint: '当前已加载 {count} 个用户的正余额合计',
      ...
      revenueFormula: '收入',
      revenueFormulaValue: '用户扣费和余额负债按人民币兑美元汇率折算；余额充值收入按充值面额价格表匹配实际人民币收款，来自 CDK 兑换和管理员余额充值，管理员用户已排除。',
      costFormula: '上游成本',
      ...
      balanceLiabilityFormulaValue: '平台余额负债按普通用户正余额合计展示，代表未来可被消费的服务义务；排行榜奖励单独作为奖励发放成本展示。',
