export default {
  ...
  admin: {
    ...
    costCalculator: {
      ...
      userBillingHint: 'Platform USD balance converted to CNY at {rate}',
      ...
      userBalanceLiabilityHint: 'Positive balances across {count} loaded users',
      ...
      revenueFormulaValue: 'User billing and balance liability are converted by the RMB-per-USD rate. Balance recharge revenue uses package prices to match actual CNY receipts from CDK redemptions and admin top-ups; admin users are excluded.',
      ...
      balanceLiabilityFormulaValue: 'Balance liability is the sum of positive non-admin user balances, representing future service obligations; leaderboard rewards are shown separately as reward cost.',
