export default {
  ...
  admin: {
    ...
    costCalculator: {
      ...
      accountCostTitle: 'Account Cost and Profit',
      accountCostDescription: 'Summarizes period revenue, usage cost, prorated fixed cost, and profit by upstream account. Fixed costs and composite usage cost rates come from cost calculator settings.',
