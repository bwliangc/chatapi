export default {
  ...
  leaderboard: {
    title: 'Leaderboard',
    description: 'A live ranking by spending. Climb to the top for a share of the daily reward pool.',
    tabToday: 'Today (live)',
    tabYesterday: 'Yesterday',
    poolAmount: 'Est. Pool',
    totalSpend: 'Total Spend',
    distributionRatio: 'Reward split: ',
    ...
    hintYesterday: "Final settlement of yesterday's full-day spend.",
    myRank: 'Your Rank',
    winnerBadge: 'Winner zone',
    rankHeader: 'Rank',
    userHeader: 'User',
    spendHeader: 'Spend',
    youLabel: 'You',
  ...
  onlinePlayground: {
    title: 'Online Test',
    description: 'Pick your key and a model, then chat right in the browser with image support. Chat history is not stored; data is only passed through to the upstream provider.',
    selectKey: 'API Key',
    noActiveKey: 'No active key',
    createKeyHint: 'You have no active API key yet. Create one on the "API Keys" page first.',
    selectModel: 'Model',
    loadingModels: 'loading…',
    modelPlaceholder: 'Type or pick a model',
    refreshModels: 'Refresh model list',
    modelsCount: 'Auto-loaded {count} models',
    modelsManualHint: 'Could not auto-load the model list — type a model name manually',
    emptyState: 'Pick a key and model, then type a message below to start chatting',
    ...
    clear: 'Clear chat',
    fileTooLarge: 'File {name} is too large (max {limit})',
    streamError: 'Error',
  ...
  admin: {
    ...
    costCalculator: {
      ...
      description: 'Accounting view for platform balances, user billing, upstream cost, fixed subscription cost, and profit',
      statementTitle: 'Operating Cost Statement',
      statementDescription: 'Summarizes real usage ledger data for the selected range and estimates upstream cost, fixed subscription cost, and profit from cost calculator settings.',
      settings: 'Settings',
      settingsTitle: 'Cost Calculator Settings',
      userBilling: 'User Billing Revenue',
      userBillingHint: 'Platform balance is estimated by weighted recharge price; falls back to {rate} when unavailable',
      upstreamCost: 'Upstream Cost',
      upstreamCostHint: 'Summed by upstream account composite usage cost rate; unconfigured accounts use default {rate}',
      usageGrossProfit: 'Usage Gross Profit',
      netAfterFixedCost: 'Profit After Fixed Cost',
      netAfterFixedCostHint: 'Fixed cost {fixed}, leaderboard rewards {rewards}',
      margin: 'Margin',
      fixedCost: 'Fixed cost',
      userBalanceLiability: 'Balance Liability',
      userBalanceLiabilityHint: '{count} non-admin users with positive balance; estimated CNY liability {estimated}, source: {source}',
      balanceRechargeRevenue: 'Balance Recharge Revenue',
      balanceRechargeRevenueHint: 'Matched {matched} by package prices, unmatched {unmatched}, {count} records',
      redeemRechargeRevenue: 'CDK Balance Recharge',
      redeemRechargeRevenueHint: '{count} used balance redeem codes',
      adminBalanceAdjustment: 'Admin Top-up Revenue',
      adminBalanceAdjustmentHint: '{count} records, platform balance added {added}, deducted {deducted}',
      leaderboardRewardCost: 'Leaderboard Rewards',
      leaderboardRewardCostHint: '{count} records, platform balance rewarded {amount}',
      unmatchedRechargeAmount: 'Unmatched Recharge Amount',
      unmatchedRechargeAmountHint: '{count} recharge records do not match a package price; add them in settings',
      accountConfiguredCost: 'Monthly Account Cost',
      accountConfiguredCostHint: '{count} accounts configured',
      accountCostTitle: 'Account Costs and Subscriptions',
      accountCostDescription: 'Fixed costs and composite usage cost rates come from cost calculator settings and do not read account extra fields.',
      proratedDays: '{days} days prorated',
      account: 'Account',
      platform: 'Platform',
      ...
      noAccounts: 'No configured account costs',
      noAccountCosts: 'No fixed account costs added yet',
      unconfigured: 'Unconfigured',
      accountingNotesTitle: 'Accounting Notes',
      revenueFormula: 'Revenue',
      revenueFormulaValue: 'User billing is estimated first by weighted actual unit price from recharge package prices or matched recharge history. Balance recharge revenue uses package prices to match actual CNY receipts from CDK redemptions and admin top-ups; admin users are excluded.',
      ...
      balanceLiabilitySourcePackage: 'current package price table',
      balanceLiabilitySourceUnavailable: 'no price data, balance only',
      groupProfitTitle: 'Group Profit',
      modelProfitTitle: 'Model Profit',
      group: 'Group',
      income: 'Income',
      cost: 'Cost',
      profit: 'Profit',
      balanceLiabilityTitle: 'Balance Liability Details',
      balanceLiabilityDescription: 'Users with the largest balances, useful for reviewing unfulfilled platform liabilities.',
      pageLoadedRows: 'Loaded {count} / {total}',
      user: 'User',
      subscriptions: 'Subscriptions',
      balanceExchangeRate: 'RMB per USD',
      balanceExchangeRateHint: 'Enter how many RMB equals 1 USD. If 6.8 CNY = 1 USD, enter 6.8.',
      balanceExchangeRateInvalid: 'RMB per USD must be greater than 0',
      upstreamCostRate: 'Default Composite Usage Rate',
      upstreamCostRateHint: 'Enter the direct CNY/USD composite rate. Example: 6.8 FX rate and 80% upstream cost => 6.8 × 0.8 = 5.44.',
      upstreamCostRateInvalid: 'Default composite usage rate cannot be negative',
      rechargePackageSettings: 'Recharge Package Prices',
      rechargePackageSettingsHint: 'Map platform balance denominations to actual CNY receipts. Example: 100 balance costs ¥15, 1000 balance costs ¥135.',
      addRechargePackage: 'Add package',
      rechargeBalanceAmount: 'Platform Balance Amount',
      rechargeActualAmount: 'Actual Receipt (CNY)',
      noRechargePackages: 'No recharge package prices added yet',
      rechargePackageBalanceInvalid: 'Recharge balance amount must be greater than 0',
      rechargePackageActualInvalid: 'Actual receipt cannot be negative',
      rechargePackageDuplicate: 'Recharge balance amounts cannot be duplicated',
      addAccountCost: 'Add Account Cost',
      selectAccount: 'Select account',
      settingsSaved: 'Cost calculator settings saved',
    ...
    channelMonitor: {
      ...
      form: {
        ...
        activeWindow: 'Detection Window',
        activeWindowHint: 'When off, checks run 24/7. When on, checks only run within the selected weekdays and time range (server local timezone)',
        activeWindowStart: 'Start time',
        activeWindowEnd: 'End time',
        activeWindowTimeHint: 'Start equal to end means all day; start later than end means it spans midnight (e.g. 22:00–06:00)',
        activeWindowWeekdays: 'Active weekdays',
        activeWindowWeekdaysHint: 'None selected means every day',
        activeWindowWeekdaysWorkday: 'Weekdays only',
        activeWindowWeekdaysEveryday: 'Every day',
        weekday0: 'Sun',
        weekday1: 'Mon',
        weekday2: 'Tue',
        weekday3: 'Wed',
    ...
    settings: {
      ...
      features: {
        ...
        onlinePlayground: {
          title: 'Online Test',
          description: 'Let signed-in users chat in the browser with their own key and a chosen model (images). Disabled by default.',
        ...
        leaderboardReward: {
          ...
          description: 'Every day, automatically take a percentage of yesterday\'s total spend as a reward pool and credit the top N users on yesterday\'s spending leaderboard. Disabled by default.',
          enabled: 'Enable Leaderboard Reward',
          enabledHint: 'When off, no daily rewards are granted. Existing reward records are kept.',
          poolRate: 'Reward Pool Rate',
          poolRateHint: 'Pool = yesterday\'s total spend (actual cost) × this rate (0-100%, e.g. 10 means 10%).',
          topN: 'Number of Winners (Top N)',
          topNHint: 'Credits the top N users by yesterday\'s spend; only users with spend yesterday are included. 0 disables granting.',
          mode: 'Distribution Mode',
          modeHint: 'Controls how the pool is split among the top N winners.',
          modeAverage: 'Equal Split',
          ...
          minSpend: 'Qualification Threshold (min spend $)',
