export default {
    ...
    groups: {
      ...
      dynamicRate: {
        ...
        min: '最低基础倍率',
        max: '最高基础倍率',
        hint: '按整个分组最近 1 小时的输入、输出、缓存 Token 总量，与历史 7 天的小时用量比较，每 5 分钟平滑调整。量少降价，量多涨价。',
        rules: '至少需要 24 小时完整历史；不足时保留当前倍率并限制在范围内。用户专属倍率优先，高峰倍率仍会叠加；独立图片、视频和显式工具定价沿用各自规则。关闭后保留当前倍率，可手动修改。',
        rangeError: '倍率须满足 0 ≤ 最低倍率 ≤ 最高倍率 ≤ 999999.9999。',
      },
      rateMultiplierHint: '1.0 = 标准费率，0.5 = 半价，2.0 = 双倍，0 = 不计费',
      platforms: {
        all: '全部平台',
