    ...
    settings: {
      ...
      features: {
        ...
        leaderboardReward: {
          ...
          displayTopN: 'Leaderboard Size (Top N)',
          displayTopNHint: 'Controls the total number of ranks users can browse. Defaults to the top 10; larger boards are paginated. Independent from the number of winners.',
      ...
      gatewayForwarding: {
        ...
        codexTimezoneRewrite: 'Codex Timezone Rewrite',
        codexTimezoneRewriteHint: 'Rewrite the timezone and current date in Codex request environment_context to the configured target timezone.',
        codexTimezone: 'Codex target timezone',
        codexTimezonePlaceholder: 'Leave empty for server timezone, e.g. America/Los_Angeles',
        codexTimezoneSearchPlaceholder: 'Search IANA timezones',
        codexTimezoneServerOption: 'Server application timezone (empty)',
        codexTimezoneHint: 'Use an IANA timezone name such as Asia/Shanghai or America/Los_Angeles; empty uses the server application timezone.',
