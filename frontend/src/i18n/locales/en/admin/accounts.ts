export default {
    accounts: {
      codexTicket: {
        ...
        accountEnabled: 'Enable 292 tickets for this account', modelEnabled: 'Enable tickets for this model', policySaved: 'Participation saved',
      ...
      abnormalNotification: 'Abnormal Notice',
      abnormalNotificationHint: 'Configure email notifications for account errors',
      abnormalNotificationSettings: 'Abnormal Notification Settings',
      abnormalNotificationEnabled: 'Email notification',
      abnormalNotificationEnabledHint: 'Send an email when the account enters a selected state',
      abnormalNotificationStatuses: 'Notify for',
      abnormalNotificationStatusRequired: 'Select at least one notification state',
      abnormalNotificationStatusLabels: {
        error: 'Account error',
        rate_limited: 'Rate limited',
        temp_unschedulable: 'Temporarily unschedulable',
        overloaded: 'Upstream overloaded',
      },
      abnormalNotificationStatusHints: {
        error: 'Authentication failures and other account errors requiring attention',
        rate_limited: 'Includes exhausted 5-hour or weekly quotas; model limits notify separately per model',
        temp_unschedulable: 'Scheduling paused due to temporary errors, repeated failures, or usage thresholds',
        overloaded: 'The upstream service is overloaded and the account enters a cooldown',
      },
      abnormalNotificationEmail: 'Recipient email',
      abnormalNotificationEmailPlaceholder: 'Enter recipient email',
      abnormalNotificationEmailHint: 'Each state sends one notice while it persists. A new notice is sent if it recurs after recovery.',
      abnormalNotificationSaved: 'Abnormal notification settings saved',
      abnormalNotificationLoadFailed: 'Failed to load abnormal notification settings',
      abnormalNotificationSaveFailed: 'Failed to save abnormal notification settings',
      autoReset: 'Auto Reset',
      autoResetHint: 'Configure automatic use of OpenAI reset credits',
      autoResetSettings: 'Automatic Reset Settings',
      autoResetEnabled: 'Use reset credits automatically',
      autoResetEnabledHint: 'Consume one reset credit when any custom condition is met',
      autoResetConditions: 'Trigger conditions',
      autoResetConditionsHint: 'Added conditions use OR logic; any matching condition can trigger a reset.',
      autoResetAddCondition: 'Add {condition}',
      autoResetRemoveCondition: 'Remove condition',
      autoResetNoConditions: 'No trigger conditions added',
      autoResetWeeklyThreshold: 'Weekly usage',
      autoResetWeeklyThresholdHint: 'Reset once when the 7-day window reaches this usage; it rearms after usage drops below the threshold.',
      autoResetExpiryMinutes: 'Trigger before expiry',
      autoResetExpiryMinutesHint: 'Reset when the earliest available credit enters this minute-based expiry window.',
      autoResetEmail: 'Notification email',
      autoResetEmailPlaceholder: 'Enter notification email',
      autoResetEmailHint: 'Send an email after every successful automatic reset.',
      autoResetSaved: 'Automatic reset settings saved',
      autoResetLoadFailed: 'Failed to load automatic reset settings',
      autoResetSaveFailed: 'Failed to save automatic reset settings',
      minutes: 'minutes',
