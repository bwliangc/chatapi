export default {
    accounts: {
      ...
      abnormalNotificationEnabledHint: 'Send automatically when the account first enters an error state',
      abnormalNotificationEmail: 'Recipient email',
      abnormalNotificationEmailPlaceholder: 'Enter recipient email',
      abnormalNotificationEmailHint: 'A new notice is sent if another error occurs after recovery',
