export default {
    accounts: {
      ...
      autoResetEnabledHint: 'Consume one reset credit when the selected condition is met',
      autoResetStrategy: 'Trigger strategy',
      autoResetWeeklyStrategy: 'Weekly threshold',
      autoResetExpiryStrategy: 'Credit nearing expiry',
