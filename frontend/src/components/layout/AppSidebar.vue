...
const flagGroupsInfo = makeSidebarFlag(FeatureFlags.groupsInfo)
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/groups-info', label: t('nav.groupsInfo'), icon: FolderIcon, hideInSimpleMode: true, featureFlag: flagGroupsInfo },
