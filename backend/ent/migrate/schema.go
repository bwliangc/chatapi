...
var (
	...
	ChannelMonitorsColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "name", Type: field.TypeString, Size: 100},
		{Name: "provider", Type: field.TypeEnum, Enums: []string{"openai", "anthropic", "gemini", "custom", "grok", "antigravity", "kimi", "zhipu", "deepseek", "minimax", "opencode_go"}},
		...
		{Name: "active_window", Type: field.TypeJSON, Nullable: true},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "dynamic_rate", Type: field.TypeJSON, Nullable: true},
		{Name: "dynamic_rate_updated_at", Type: field.TypeTime, Nullable: true},
