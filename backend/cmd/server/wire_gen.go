...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountRepository := repository.NewAccountRepository(client, db, schedulerCache, notificationEmailService)
	...
	openAIQuotaService := service.ProvideOpenAIQuotaService(accountRepository, proxyRepository, openAITokenProvider, privacyClientFactory, openAIReferralClient, openAIGatewayService, leaderLockCache, db)
	...
	accountHandler := handler.ProvideAdminAccountHandler(configConfig, adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, rateLimitService, accountUsageService, accountTestService, concurrencyService, crsSyncService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator, grokQuotaService, notificationEmailService)
	...
	costCalculatorHandler := admin.NewCostCalculatorHandler(settingService, usageLogRepository, redeemCodeRepository, userRepository)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, pluginHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, costCalculatorHandler, affiliateHandler, complianceHandler, auditLogHandler, upstreamBillingProbeService, ollamaCloudUsageService, openCodeGoUsageService)
	...
	leaderboardHandler := handler.NewLeaderboardHandler(dashboardService, settingService, leaderboardRewardRepository)
	luckySecondRepository := repository.NewLuckySecondRepository(db)
	luckySecondService := service.NewLuckySecondService(luckySecondRepository, settingService, billingCacheService)
	luckySecondHandler := handler.NewLuckySecondHandler(luckySecondService)
	...
	groupRatesHandler := handler.NewGroupRatesHandler(apiKeyService, usageLogRepository)
