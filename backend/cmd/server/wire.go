...
func provideCleanup(
	...
	customOpenAIAutoReset *service.OpenAIAutoResetService,
	ollamaCloudUsage *service.OllamaCloudUsageService,
	auditLog *service.AuditLogService,
	openAIQuotaAutoReset *service.OpenAIQuotaAutoResetService,
	promptAudit *securityaudit.PromptService,
	pluginManager *service.PluginManager,
) func() {
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"OpenAIQuotaAutoResetService", func() error {
				if openAIQuotaAutoReset != nil {
					openAIQuotaAutoReset.Stop()
				}
				return nil
			}},
			...
			{"OpenAIAutoResetService", func() error {
				if customOpenAIAutoReset != nil {
					customOpenAIAutoReset.Stop()
				}
				return nil
			}},
