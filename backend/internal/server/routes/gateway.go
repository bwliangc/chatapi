...
func RegisterGatewayRoutes(
	...
	luckySecond := h.LuckySecond.GatewayMiddleware()
	...
	gateway.Use(clientRequestID, luckySecond)
	...
	gemini.Use(clientRequestID, luckySecond)
	...
	rootRoute := func(method, path string, limit gin.HandlerFunc, handler gin.HandlerFunc) {
		r.Handle(method, path, limit, clientRequestID, luckySecond, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), groupModelAllowlist, compositeTarget, requireGroupAnthropic, handler)
	}
	...
	codexDirect.Use(bodyLimit, clientRequestID, luckySecond, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), groupModelAllowlist, compositeTarget, requireGroupAnthropic)
	{
	...
	antigravityV1.Use(clientRequestID, luckySecond)
	...
	antigravityV1Beta.Use(clientRequestID, luckySecond)
