...
// IsLeaderboardRewardEnabled checks the leaderboard reward master switch.
...
// IsLeaderboardRankingVisibleEnabled controls whether users can see the ranking page.
...
func (s *SettingService) GetLeaderboardRewardMinSpend(ctx context.Context) float64 {
	...
	return clampLeaderboardRewardMinSpend(value)
}
...
func (s *SettingService) GetLeaderboardRewardTopN(ctx context.Context) int {
	...
	if value > LeaderboardRewardTopNMax {
