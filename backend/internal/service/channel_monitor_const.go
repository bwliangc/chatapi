...
const (
	...
	// antigravity/kimi/zhipu/deepseek 为配额模式引入：
...
var (
	...
	ErrChannelMonitorInvalidProvider = infraerrors.BadRequest(
		"CHANNEL_MONITOR_INVALID_PROVIDER", "provider must be one of openai/anthropic/gemini/custom/grok/antigravity/kimi/zhipu/deepseek/minimax",
	)
