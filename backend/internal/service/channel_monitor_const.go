...
const (
	...
	// MonitorProviderOpenAI / Anthropic / Gemini / Custom provider 字符串常量（也是 ent enum 的实际值）。
...
var (
	...
	ErrChannelMonitorInvalidProvider = infraerrors.BadRequest(
		"CHANNEL_MONITOR_INVALID_PROVIDER", "provider must be one of openai/anthropic/gemini/custom",
	)
